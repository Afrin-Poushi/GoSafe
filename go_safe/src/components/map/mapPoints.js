  ...
  componentDidMount() {
    ...
    const pointsGeoJson = new L.GeoJSON(pointsJson, {
      onEachFeature: (feature = {}, layer) => {
        ...
        latArr.push(new L.LatLng(coordinates[0], coordinates[1], "taskU"));
        // console.log(newLatLngA);
        // var newLatLngB = new L.LatLng(39.952812, -83.119293, "taskA");
    ...
    for (i = 0; i < latArr.length; i++) {
      routeControl.setWaypoints([latArr[i], latArr[i + 1], latArr[i + 2]]);
